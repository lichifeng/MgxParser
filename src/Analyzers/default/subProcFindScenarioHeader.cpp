...
void DefaultAnalyzer::_findScenarioHeaderStart() {
    ...
    if (IS_DE(versionCode)) {
        ...
        throw(ParserException("[WARN] Cannot find satisfied _scenarioHeaderPos in this DE version. \n"));
    }
    ...
    if (rFound == _header.rend()) {
        ...
        throw(ParserException("[WARN] Cannot find satisfied _scenarioHeaderPos. \n"));
    } else {
